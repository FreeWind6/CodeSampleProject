...
public class SynchronizedBlocks {
    private final Object lock1 = new Object(); //чтобы разделить 2 потока в паралель
    ...
    private void copy() {
        ...
        try {
            thread1.join(); //join - чтобы время выводилось
            thread2.join(); //после выполнения всей программы, а не до
