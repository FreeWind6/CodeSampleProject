...
public class VolatileMain {
    ...
    private static volatile int counter; //Volatile - применяется к переменной чтобы дать ей понять мы в нее сначала можем писать, а затем читать.
    ...
    private static class SimpleWriter extends Thread { //запись
    ...
    private static class SimpleReader extends Thread { //чтение
